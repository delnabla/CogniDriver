...
\begin{itemize}
	\item NeuroPhone \cite{neurophone} is an application which uses the \Gls{P300} signal and allows the user to scroll through photos of 6 contacts at a time. Once the person the user is looking for is found, the application will dial that person's number.
